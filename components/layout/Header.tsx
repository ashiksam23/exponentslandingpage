        ...
        <div className="flex items-center gap-4 sm:gap-6">
          <nav className="hidden md:flex items-center gap-8 mr-2">
            ...
            <button
              ...
              className={`text-xs font-bold uppercase tracking-widest hover:text-brand-black dark:hover:text-white transition-colors ${currentPage === 'casestudies' ? 'text-brand-black dark:text-white' : 'text-brand-neutral-500 dark:text-brand-neutral-400'}`}
            >
              Case Studies
            </button>
