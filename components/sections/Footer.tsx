...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-white dark:bg-brand-black border-t border-brand-neutral-200 dark:border-brand-neutral-800 pt-24 pb-12 transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 flex flex-col items-center text-center relative z-10">
        ...
        <div className="max-w-3xl mx-auto mb-20">
           <p className="text-2xl md:text-3xl font-medium mb-10 transition-colors duration-300 leading-tight">
        ...
        <div className="w-full border-t border-brand-neutral-200 dark:border-brand-neutral-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-brand-neutral-500 dark:text-brand-neutral-600 text-[10px] uppercase tracking-widest transition-colors duration-300">
          ...
          <p>&copy; {new Date().getFullYear()} ExponentOS Inc.</p>
