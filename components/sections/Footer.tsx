  ...
  return (
    <footer className="bg-white dark:bg-brand-black border-t border-brand-neutral-200 dark:border-brand-neutral-800 pt-16 md:pt-24 pb-12 transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 flex flex-col items-center text-center relative z-10">
        ...
        <h2 className="text-4xl sm:text-5xl md:text-8xl font-bold mb-10 tracking-tighter uppercase leading-[0.85] select-none transition-colors duration-500 ease-premium">
          Stop Managing.<br />
          <span className="text-brand-red">Lead Now.</span>
        </h2>

        <div className="max-w-3xl mx-auto mb-20">
          <p className="text-xl md:text-3xl font-light mb-12 transition-colors duration-500 ease-premium leading-tight tracking-wide">
            <span className="text-brand-neutral-400 dark:text-brand-neutral-500 block sm:inline">The 1x world manages people.</span>
            <span className="hidden sm:inline"> </span>
            <span className="text-brand-black dark:text-white font-medium block sm:inline">The 10x world installs leverage.</span>
          </p>
          <div className="flex flex-col items-center gap-6">
            <Button
              variant="primary"
              size="lg"
              className="w-full sm:w-auto px-12 py-4 text-sm shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)] hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_#E24A37] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all duration-300 ease-premium font-bold tracking-widest uppercase"
            >
              {SITE_CONFIG.ctaText}
            </Button>
