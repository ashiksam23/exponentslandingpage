        ...
        <div className="lg:col-span-5">
          <div className="relative lg:sticky top-0 lg:top-32 mb-12 lg:mb-0">
            ...
            <motion.h2 
              ...
              className="text-5xl md:text-6xl font-bold text-brand-black dark:text-white mb-8 tracking-tighter uppercase leading-[0.9] transition-colors duration-300"
            >
              The Bottleneck<br/>
            ...
            <motion.div 
              ...
              className="p-6 border-l border-brand-neutral-200 dark:border-brand-neutral-800 bg-brand-neutral-50 dark:bg-brand-neutral-900/30 backdrop-blur-sm relative overflow-hidden"
            >
              {/* Scan Line Animation */}
              <motion.div 
              ...
              return (
                <motion.div 
                  ...
                  className={`
                    ...
                    transition-all duration-500 cursor-crosshair group mb-0 sm:mb-4 last:mb-0 last:border-b-0 sm:last:border-b
                    ${isHovered 
                      ? 'bg-brand-black dark:bg-brand-neutral-900 border-brand-red dark:border-brand-red translate-x-0 sm:-translate-x-4 z-10 shadow-[8px_8px_0px_0px_rgba(226,74,55,0.2)]' 
