            ...
            return (
              <motion.div 
                ...
                className={`
                  ...
                  ${isHighlight 
                    ? 'bg-brand-black dark:bg-brand-neutral-100 text-white dark:text-brand-black md:scale-[1.02] z-10 shadow-2xl' 
              ...
              >
                ...
                <div className="flex-grow space-y-4 mb-12 relative z-10">
